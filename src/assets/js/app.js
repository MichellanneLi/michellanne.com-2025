...
$(window).scroll(function() {
    ...
    if (scroll > $('.site-header.sticky').height()) {
        $(".site-header.sticky").data('timer', setTimeout(function(){
          $(".site-header.sticky").addClass('stuck');
        },200));
    } else {
        $(".site-header.sticky").data('timer', setTimeout(function(){
            $(".site-header.sticky").removeClass('stuck');
        },200));
    }
});
...
$('.main-nav__trigger').click(function() {
  if ($(this).hasClass('is-active')) {
    ...
    $('.main-nav__drawer').slideDown();
    $('.main-nav__drawer').addClass('is-open');
  }
});